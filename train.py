...
def main():
    trainloader, validloader, testloader, train_data = utils.load_data(in_arg.data_dir)
    ...
    utils.save_checkpoint(model, optimizer, path=in_arg.save_dir, arch=in_arg.arch, hidden_units=in_arg.hidden_units, epochs=in_arg.epochs)
